...
def send_notif():
    ...
    def write_notif_record(user_id, telegram_id, event_datetime, selected_time, counted_time, event_name, notif_event_id):
        ...
        cursor.execute("""
                        ...
                        """, (user_id, telegram_id, event_datetime, selected_time, counted_time, 'Active', event_name, notif_event_id))
